...
## ------------------------------------------------------------------------------------
def get_variational_encoder_test_Conv(input_dim, encoding_dim, latent_dim):
...
## ------------------------------------------------------------------------------------
def get_variational_encoder_test_Dense(input_dim, encoding_dim, latent_dim):
...
## ------------------------------------------------------------------------------------
def get_decoder_test_Conv(input_dim, encoding_dim, latent_dim):
  latent_inputs = keras.Input(shape=(latent_dim,))
